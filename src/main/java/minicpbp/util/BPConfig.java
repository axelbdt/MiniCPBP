 ...
 *      topo      Infer.NET-style static schedule: dependency graph over
 *                factor-to-variable messages, Tarjan condensation, acyclic
 *                blocks executed once, each cyclic block iterated in a
 *                greedy order that minimises stale (backward) edges
